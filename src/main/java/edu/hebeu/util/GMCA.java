...
////    }
//
//    public static String genGMCACert(PrivateKey pri,PublicKey pub) throws Exception {
...
//        X509v3CertificateBuilder certGen = new JcaX509v3CertificateBuilder(iss, BigInteger.valueOf(1), new Date(System.currentTimeMillis() - 50000),
//                new Date(System.currentTimeMillis() + 50000), iss, pubKey).addExtension(new ASN1ObjectIdentifier("2.5.29.15"), true,
//                new X509KeyUsage(0xfe)).addExtension(new ASN1ObjectIdentifier("2.5.29.37"), true, new DERSequence(KeyPurposeId.anyExtendedKeyUsage)).addExtension(new ASN1ObjectIdentifier("2.5.29.17"), true,
...
//
//        String cert1 = Base64.toBase64String(cert.getEncoded());
...
//        return cert1;
//    }//庆荣，正式生成传公私钥即可
//    public static String genGMCACert1() throws Exception {  //test 测试
//        System.out.println("=============测试生成国密CA根证书=============");
//        KeyPairGenerator g = KeyPairGenerator.getInstance("EC", "BC");
//
//        g.initialize(new ECNamedCurveGenParameterSpec("sm2p256v1"));
